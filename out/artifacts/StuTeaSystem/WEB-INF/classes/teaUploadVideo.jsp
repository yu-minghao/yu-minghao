...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-list">
            ...
            <a href="${pageContext.request.contextPath}/uploadServlet?action=findAllVideo">视频信息管理</a>
            <span class="crumb-step">&gt;</span>
            <span class="crumb-name">上传视频</span>
        </div>
        <div class="result-wrap">
            <form name="videoForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadServlet?action=addVideo">
                <table>
                    <tr>
                        <td>作者：</td>
                        <td>
                    ...
                    <tr>
                        <td>上传视频：</td>
                        <td>
                            <input type="file" name="video" value="上传视频" class="button1">
                        </td>
                    </tr>
                    <tr>
                        <td></td>
