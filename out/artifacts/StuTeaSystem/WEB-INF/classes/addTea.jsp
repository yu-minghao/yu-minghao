...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/userServlet?action=findAllTea"><i class="icon-font">&#xe004;</i>教师信息管理</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="${pageContext.request.contextPath}/addStu.jsp"><i class="icon-font">&#xe008;</i>添加学生</a>
                        </li>
                        <li><a href="${pageContext.request.contextPath}/userServlet?action=findAllStu"><i class="icon-font">&#xe004;</i>学生信息管理</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="crumb-wrap">
        <div class="crumb-list">
            ...
            <a href="${pageContext.request.contextPath}/userServlet?action=findAllTea">教师信息管理</a>
            <span class="crumb-step">&gt;</span>
            <span class="crumb-name">新增教师</span>
        </div>
        <div class="main-wrap" style="margin-left: 215px;margin-top:10px ">
            <form action="${pageContext.request.contextPath}/userServlet" method="post">
                <input type="hidden" name="action" value="addTea"/>
                <table>
                    <tr>
                        <th class="th-left">
                        ...
                        <th class="th-right">
                            <label>
                                <input type="text" name="teaNo" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th class="th-right">
                            <label>
                                <input type="text" name="teaName" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th class="th-right">
                            <label>
                                <input type="password" name="teaPassword" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
