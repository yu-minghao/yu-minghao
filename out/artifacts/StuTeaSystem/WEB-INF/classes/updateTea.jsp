...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/stuInfoManage.jsp">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list">
            ...
            <span class="crumb-step">&gt;</span>
            <span class="crumb-name">修改教师信息</span>
        </div>
        <div class="main-wrap" style="margin-left: 215px;margin-top:10px ">
            <form action="${pageContext.request.contextPath}/userServlet" method="post">
                <input type="hidden" name="action" value="updateTea"/>
                <input type="hidden" name="teaId" value="${user.teaid}"/>
                <table>
                    <tr>
                        <th class="th-left">
                        ...
                        <th class="th-right">
                            <label>
                                <input type="text" value="${user.teano}" name="teaNo" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th class="th-right">
                            <label>
                                <input type="text" value="${user.teaname}" name="teaName" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th class="th-right">
                            <label>
                                <input type="password" name="teaPassword" value="${user.teapassword}" class="input">
                            </label>
                        </th>
                    </tr>
                    <tr>
