    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list">
                ...
                <span class="crumb-name">教师信息管理</span>
            </div>
        </div>
                ...
                <form action="#" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <td><div class="btn btn-primary btn2"><a href="lostmood.jsp"><font color="#f0f8ff">查询</font></a></div></td>
        ...
        <div class="result-wrap">
            <form name="myForm" id="myForm" method="post" action="${pageContext.request.contextPath}/userServlet">
                <input type="hidden" name="action" value="delMoreTea"/>
                <div class="result-title">
                    <div class="result-list">
                        <a href="${pageContext.request.contextPath}/addTea.jsp">
                            <i class="icon-font"></i>新增教师
                        </a>
                        <a id="batchDel" href="javascript:myForm.submit();">
                            <i class="icon-font">&#xe037;</i>批量删除
                        </a>
                        <a id="updateOrd" href="${pageContext.request.contextPath}/userServlet?action=findAllTea">
                        ...
                        <table class="result-tab" width="100%">
                            ...
                            <c:forEach items="${list}" var="item" >
                                <tr>
                                    <td class="tc">
                                        <label>
                                            <input name="sel" id="sel" value="${item.teaid}" type="checkbox">
                                        </label>
                                    </td>
                                    <td>${item.teaid}</td>
                                    <td>${item.teano}</td>
                                    ...
                                    <td>
                                        <a class="link-update"
                                           href="${pageContext.request.contextPath}/userServlet?action=updateBeforeTea&teaId=${item.teaid}">修改&nbsp;</a>|
                                        <a class="link-del"
                                           href="${pageContext.request.contextPath}/userServlet?action=delTea&teaId=${item.teaid}">&nbsp;删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
