...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        } else if ("findAllFile".equals(action)) {
            try {
    ...
    private void addFile(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        ...
        try {
            ...
            for (FileItem item : list) {
                ...
                if (item.isFormField()) {
                    ...
                    //创建一个文件输出流
                    FileOutputStream fos = new FileOutputStream(savePathStr + java.io.File.separator + fileName);
                    //创建一个缓冲区
        ...
        //file1.setTitle(name);
        file1.setAuthor(request.getParameter("author"));
