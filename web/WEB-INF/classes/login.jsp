...
<head>
    ...
    <script type="text/javascript">
        ...
        function refresh(){
            form1.imgValidate.src=${pageContext.request.contextPath}/VerifyServlet";
        }
    </script>
</head>
...
<div id="login-box">
    ...
    <form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/loginDoServlet">
        ...
        <div class="input-box">
            <i class="icon iconfont">&#xe6a8;</i>
            <label>
                <input type="text" id="validateCode" name="verifycode" size="3">
            </label>
            <img name="imgValidate" src="${pageContext.request.contextPath}/VerifyServlet" onclick="refresh()">
        </div>
        <div class="input-box">
